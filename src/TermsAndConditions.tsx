    ...
    mondayWednesday: [
      {
        ...
        rango: 'US$5 a US$20',
        bonoMaximo: 'US$80',
        gananciaMaxima: 'US$150',
      },
      {
        bono: '60%',
        rollover: 'X4',
        rango: 'US$20,01 a US$59,99',
        bonoMaximo: 'US$80',
        gananciaMaxima: 'US$250',
      },
      {
        bono: '80%',
        rollover: 'X3',
    ...
    mondayWednesday: [
      {
        ...
        bonoMaximo: '$80.000 CLP',
        gananciaMaxima: '$150.000 CLP',
      },
      {
        bono: '60%',
        rollover: 'X4',
        rango: '$20.001 a $59.999 CLP',
        bonoMaximo: '$80.000 CLP',
        gananciaMaxima: '$250.000 CLP',
      },
      {
        bono: '80%',
        rollover: 'X3',
        rango: 'Desde $60.000 CLP',
        bonoMaximo: '$80.000 CLP',
        gananciaMaxima: '$300.000 CLP',
      },
    ],
    thursdayFriday: [
      {
    ...
    mondayWednesday: [
      {
        ...
        bonoMaximo: 'Bs. 4.000',
        gananciaMaxima: 'Bs. 7.500',
      },
      {
        bono: '60%',
        rollover: 'X4',
        rango: 'Bs. 3.001 a Bs. 4.999',
        bonoMaximo: 'Bs. 4.000',
        gananciaMaxima: 'Bs. 12.500',
      },
      {
        bono: '80%',
        rollover: 'X3',
        rango: 'Desde Bs. 5.000',
        bonoMaximo: 'Bs. 4.000',
        gananciaMaxima: 'Bs. 15.000',
      },
    ],
    thursdayFriday: [
      {
    ...
    mondayWednesday: [
      {
        ...
        bonoMaximo: 'MX$80',
        gananciaMaxima: 'MX$150',
      },
      {
        bono: '60%',
        rollover: 'X4',
        rango: 'MX$160,01 a MX$259',
        bonoMaximo: 'MX$80',
